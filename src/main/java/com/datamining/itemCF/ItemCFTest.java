...
public class ItemCFTest {
    ...
    public static void main(String[] args) throws IOException, TasteException {
        //构造模型
        DataModel dataModel =
                new GenericBooleanPrefDataModel(new FileDataModel(new File("/Users/wongleon/data/ml-latest-small/ratings_nohead.csv")));
...
//                GenericItemBasedRecommender itemBasedRecommender = new GenericItemBasedRecommender(dataModel, similarity);
        ...
        double score = evaluator.evaluate(recommenderBuilder, null, dataModel, 0.7, 0.3);
        ...
        IRStatistics stats = genericRecommenderIRStatsEvaluator.evaluate(recommenderBuilder, null, dataModel, null, 5, GenericRecommenderIRStatsEvaluator.CHOOSE_THRESHOLD, 1);
